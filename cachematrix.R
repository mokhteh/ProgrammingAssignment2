...
## This function is to set/get the matrix and its inversion, if any and return.
...
## this function is to look for the inversion in cache, if any; otherwise, it will calculate it and return it.
